...
function App() {
    ...
    React.useEffect(() => {
        try {
            (async() => {
                await axios.get('https://65f99361df151452461201d9.mockapi.io/skirt/skirts')
                    .then(res => {
                        setCart(res.data);
                        setLoading(res.data);
                    })
                await axios.get('https://625d747595cd5855d62136ef.mockapi.io/cart')
                    .then(res => {
                        setCard(res.data);
                    })

                await axios.get('https://625d747595cd5855d62136ef.mockapi.io/favorite')
                    .then(res => {
                        setFavorite(res.data);
                        setIsLoadingFavorite(res.data);
                    })
                await axios.get('https://625d747595cd5855d62136ef.mockapi.io/order')
                    .then(res => {
                        setOrder(res.data);
            ...
            <div className="App clear">
                ...
                <Routes >
                    ...
                    <Route path={process.env.PUBLIC_URL + '/favorite'} element={
                        <Favorite isLoadingFavorite = {isLoadingFavorite}/>
                    }/>
                    <Route path={process.env.PUBLIC_URL + '/orders'} element={
                        <Orders isLoading = {isLoading} />
                    }/>
                    <Route path={process.env.PUBLIC_URL + '/product/:id'} element={
